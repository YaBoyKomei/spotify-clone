...
headers = {
    ...
    "Referer": "https://music.youtube.com/playlist?list=OLAK5uy_lSTp1DIuzZBUyee3kDsXwPgP25WdfwB40",
...
payload = {
    ...
    "suggestStats": {
        ...
        "firstEditTimeMsec": 3726274,
        "lastEditTimeMsec": 3751998
    },
...
# Save the response to search_output.json
with open('search_output.json', 'w', encoding='utf-8') as f:
    json.dump(response.json(), f, indent=2, ensure_ascii=False)

print(f"Response saved to search_output.json with status code: {response.status_code}")
